...
def run_goal_directed_sweeps(
    ...
    # Gridworld plots
    eh.plot_metric(summ_g, "gridworld", "mean_hazards", "Gridworld: Hazard Contacts vs Horizon")
    plt.savefig(os.path.join(outdir, "gridworld_hazards.png"), dpi=150, bbox_inches='tight')

    eh.plot_metric(summ_g, "gridworld", "success_rate", "Gridworld: Success Rate vs Horizon")
    plt.savefig(os.path.join(outdir, "gridworld_success.png"), dpi=150, bbox_inches='tight')

    eh.plot_metric(summ_g, "gridworld", "mean_time", "Gridworld: Time-to-Goal vs Horizon")
    plt.savefig(os.path.join(outdir, "gridworld_time.png"), dpi=150, bbox_inches='tight')

    # Corridor plots
    eh.plot_metric(summ_c, "corridor", "mean_hazards", "Corridor: Hazard Contacts vs Horizon")
    plt.savefig(os.path.join(outdir, "corridor_hazards.png"), dpi=150, bbox_inches='tight')

    eh.plot_metric(summ_c, "corridor", "success_rate", "Corridor: Success Rate vs Horizon")
    plt.savefig(os.path.join(outdir, "corridor_success.png"), dpi=150, bbox_inches='tight')

    eh.plot_metric(summ_c, "corridor", "mean_time", "Corridor: Time-to-Goal vs Horizon")
    plt.savefig(os.path.join(outdir, "corridor_time.png"), dpi=150, bbox_inches='tight')
